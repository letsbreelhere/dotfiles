...
PROMPT='%K{reset}%F{white}╭[%K{reset}${return_status}%F{yellow}${hostname} %F{blue}${dirname}%F{magenta}${vcs_info_msg_0_}${vcs_status_string}%K{reset}%F{white}]
%F{white}╰▸%F{reset}%K{reset} '
